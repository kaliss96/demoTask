...
class TaskControllers{
	...
	function get_all_tasks()
	{
		...
		$request_fields=array("api_key"=>API_TOKEN, "job_type"=>"0","start_date"=>"2020-12-01","end_date"=>"2020-12-30","is_pagination"=>"1","requested_page"=>"1");
	...
	function delete_task()
	{
		...
		$dateLessMonth = Date('Y/m/d', strtotime("+30 days"));
	    $request_fields=array("api_key"=>API_TOKEN, "job_type"=>"0","start_date"=>$currentDate,"end_date"=>$dateLessMonth,"is_pagination"=>"1","requested_page"=>"1");
